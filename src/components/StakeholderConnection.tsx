...
export default function StakeholderConnection() {
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            One Platform. <span className="text-emerald-600">Every Stakeholder.</span> Connected.
          </h2>
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            EduLink creates a seamless ecosystem where students, agents, staff, and vendors work in perfect harmony.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Updates propagate instantly across all stakeholders</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Role-based permissions protect sensitive data</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 text-sm">Smart automation significantly reduces manual work</p>
            </motion.div>
          </div>
        </motion.div>
      </div>
